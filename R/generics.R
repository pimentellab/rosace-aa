...
#' @param blosum.info Boolean, whether to output the blosum-level score
#' @param pos.act.info Boolean, whether to output the position-level blosum-activation score
...
#' @export
#'
OutputScore <- function(object, pos.info = FALSE, blosum.info = FALSE, pos.act.info = FALSE, sig.test = 0.05, ...) {
